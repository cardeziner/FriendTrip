  ...
  return(
    <div className="bg-gray">
      ...
      <div className="row center">
        <div className="col-5">
          <BackdropFilter
          className="bord opac-black pad"
          filter={"blur(20px)"}
          >
          <h4 className="text-white">
            <h1 className=" bodytext center accent-red">Welcome to FriendTrip!</h1><br/>
            ...
            <h1 className="bodytext center accent-red">Thats where FriendTrip comes in!</h1><br/>
