...
#
# user1 = User.create(first_name: "Peter", last_name: "Stevens", email:"peter@gmail.com", password: "password")
...
#
# trip1 = Trip.create(id: 1, name:"Boys Trip", city:"San Diego", state:"CA", start_date: "09/15/2020", end_date: "09/20/2020")
# trip1 = Trip.create(id: 2, name:"Peters Trip", city:"San Diego", state:"CA", start_date: "09/15/2020", end_date: "09/20/2020")
#
#
# tripmember1 = Tripmember.create(user_id: 1, trip_id: 1)
# tripmember2 = Tripmember.create(user_id: 2, trip_id: 1)
# tripmember1 = Tripmember.create(user_id: 1, trip_id: 2)
#
#
...
# # flight2 = Flight.create(airline: "American", on_time_status: "yes", departure_date: "11/02/2021", departure_time: "06:10:17", arrival_date: "11/03/2021", arrival_time: "16:10:17")
